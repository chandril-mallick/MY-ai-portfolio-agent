...
- **Fluid Background**: Interactive WebGL fluid simulation that responds to cursor movement.
- **Categorized Skills**: Verified skill sets with visual icons (Machine Learning vs Software Engineering).
...
1.  **Clone the repository**
    ```bash
    git clone https://github.com/chandril-mallick/portfolio.git
    cd portfolio
    ```
