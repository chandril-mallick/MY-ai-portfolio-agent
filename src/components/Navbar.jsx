...
export default function Navbar({ activeSection, onNavigate }) {
  return (
    <nav
      className="fixed bottom-0 left-0 right-0 z-50 md:bottom-8 md:left-1/2 md:-translate-x-1/2 md:w-auto w-full safe-bottom"
        ...
        {NAV_ITEMS.map((item) => {
          ...
          return (
            ...
            >
              ...
              {isActive && (
                <span className="absolute -top-0.5 left-1/2 -translate-x-1/2 w-1 h-1 rounded-full bg-cyan-300 md:hidden" aria-hidden />
              )}
