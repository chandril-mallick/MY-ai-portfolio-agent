...
export default function About() {
  return (
    <div className="space-y-12 max-w-5xl mx-auto pb-10">
      ...
      >
        <p className="text-3xl md:text-4xl leading-tight font-black tracking-tight text-white">
          Applied Machine Learning Engineer
        </p>
        <p className="text-xl md:text-2xl leading-relaxed font-medium text-slate-400 mt-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <motion.div 
           ...
           className="bg-slate-900/40 p-8 rounded-[2rem] border border-white/5 shadow-2xl backdrop-blur-md group hover:border-blue-500/30 transition-all duration-500"
        >
        ...
        <motion.div 
           ...
           className="bg-slate-900/40 p-8 rounded-[2rem] border border-white/5 shadow-2xl backdrop-blur-md group hover:border-purple-500/30 transition-all duration-500"
        >
          <div className="flex items-center gap-4 mb-4">
      ...
      <motion.div 
        ...
        className="bg-slate-900/20 p-8 md:p-12 rounded-[2.5rem] border border-white/5 shadow-inner"
      >
        <h3 className="text-white font-black text-2xl mb-10 flex items-center gap-4 uppercase tracking-widest">
